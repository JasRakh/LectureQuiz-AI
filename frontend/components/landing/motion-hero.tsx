  ...
  return (
    <Box sx={{ position: 'relative', display: 'flex', flexDirection: 'column', gap: 2.5 }}>
      ...
      >
        ...
        >
          ...
          <Box
            component='span'
            sx={{
              background: 'linear-gradient(90deg,#a5b4fc,#38bdf8,#4ade80)',
      ...
      >
        ...
        >
          LectureQuiz AI listens to your lectures, understands the concepts, and generates
          concept-aligned quizzes for every cohort. No more manual question writing. No more generic
          test banks.
        </Typography>
      </motion.div>
