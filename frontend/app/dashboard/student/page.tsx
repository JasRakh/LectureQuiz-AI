  ...
  if (activeQuiz && result) {
    return (
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, maxWidth: 720, mx: 'auto' }}>
        ...
        <Paper sx={{ p: 3, borderRadius: 3, bgcolor: 'rgba(15,23,42,0.95)', textAlign: 'center' }}>
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
      <Box component='header'>
        <Typography
          variant='caption'
          sx={{ letterSpacing: '.2em', textTransform: 'uppercase', color: '#6ee7b7' }}
        >
          STUDENT DASHBOARD
        </Typography>
                    ...
                    >
                      ...
                      {!hasQuiz && (
                        <Chip
                          label='Pending'
                          size='small'
                          sx={{ bgcolor: '#1e293b', color: '#9ca3af', fontSize: 10 }}
                        />
                      )}
                    </Box>
                  </Paper>
